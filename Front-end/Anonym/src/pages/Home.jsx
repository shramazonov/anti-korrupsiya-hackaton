    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroCards}>
          <Link to="/murojaat" className={styles.heroCard}>
            ...
            <div className={styles.heroCardBody}>
              <span className={styles.heroCardTitle}>Murojaat yuborish</span>
              <span className={styles.heroCardDesc}>Korrupsiya faktini anonim ravishda bildiring</span>
            </div>
            <svg className={styles.heroCardArrow} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              <line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/>
            </svg>
          </Link>

          <Link to="/baholash" className={styles.heroCard}>
            <div className={styles.heroCardIcon}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className={styles.heroCardBody}>
              <span className={styles.heroCardTitle}>Xodimlarni baholash</span>
              <span className={styles.heroCardDesc}>Muassasa xodimlarining xizmat sifatini baholang</span>
            </div>
            <svg className={styles.heroCardArrow} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              <line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/>
            </svg>
